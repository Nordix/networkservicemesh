...
func TestInterdomainOvSForwarderVXLAN(t *testing.T) {
	if testing.Short() {
		t.Skip("Skip, please run without -short")
		return
	}

	testInterdomainOvSForwarder(t, 2, 1, "VXLAN")
}

func testInterdomainOvSForwarder(t *testing.T, clustersCount int, nodesCount int, remoteMechanism string) {
	g := NewWithT(t)
